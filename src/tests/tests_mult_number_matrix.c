...
Suite* suite_mult_number_matrix(void) {
  ...
  tcase_add_test(tc, mult_number_matrix_test_error_0);  // ERROR_CALCULATION
  tcase_add_test(tc, mult_number_matrix_test_error_1);  // ERROR_INCORRECT
  tcase_add_test(tc, mult_number_matrix_test_0);        // OK
  tcase_add_test(tc, mult_number_matrix_test_1);        // OK
